...
import { Input } from '@/components/ui/input' // Компоненты UI.
import { ArrowRight, Plus, X } from 'lucide-react'// Иконки.
...
const FourthStep = () => {
  ...
  return (
    <div className="w-full p-5 shadow-lg border-t-4 rounded-lg overflow-y-auto">
      ...
      {educationList?.length > 0 && educationList?.map((education, index)=> (<div key={index} className="mb-10">
        <Input 
        name="name" 
        type="text" 
